...
<p align = "justify">
  A estratégio PICo é o acrônimo para as seguintes palavras: (a) <b>P</b> = População; (b) <b>I</b> = População; e (c) <b>Co</b> = Contexto. A Tabela <a href = "#q1-1">1.1</a> apresenta o significado de cada uma dessas palavras.
</p>
...
<p align = "justify">
  Com isso podemos montar o seguinte problema de pesquisa: <i>É possível estimar o tempo para inicio de manutenção de estruturas de concreto existentes e sujeitas corrosão com o uso de confiabilidade estrutural?</i>
</p>
